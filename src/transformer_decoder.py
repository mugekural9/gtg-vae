"""                                                                                                                                   
Implementation of "Attention is All You Need" from S2SAMRParser- https://github.com/xdqkid/S2S-AMR-Parser                                                                                       
"""                                                                                                                                  
...
class TransformerDecoderLayer(nn.Module):                                                                                            
  def __init__(self, d_model, heads, d_ff, dropout):                                                                                 
    ...
    self.self_attn = sublayer.MultiHeadedAttention( heads, d_model, dropout=dropout)                                                                                               
                                                                                                                                     
    self.context_attn = sublayer.MultiHeadedAttention(heads, d_model, dropout=dropout)                                                                                               
...
class TransformerDecoder(nn.Module):                                                                                                 
  ...
  def forward(self, tgt, step=None):                                                                                                 
    ...
    src_pad_mask = src_words.data.eq(pad_idx).unsqueeze(1)[:,:,:1]  #[B, 1, T_src] we forced it [1,1,1]                                                         
