...
from data.dataset_readers.amr_parsing.io import AMRIO
from data.dataset_readers.amr_parsing.amr import AMRGraph
from utils.file import cached_path
from data.dataset_readers.dataset_reader import DatasetReader
from data.fields import TextField, SpanField, SequenceLabelField, ListField, MetadataField, Field, AdjacencyField, ArrayField
from data.instance import Instance
from data.token_indexers import TokenIndexer, SingleIdTokenIndexer
from data.tokenizers import Token
from data.tokenizers.bert_tokenizer import AMRBertTokenizer
from utils.checks import ConfigurationError
from utils.string import START_SYMBOL, END_SYMBOL
...
class AbstractMeaningRepresentationDatasetReader(DatasetReader):
    ...
    def _read(self, file_path):
        ...
        for i,amr in enumerate(AMRIO.read(file_path)):
            ...
            # print("i: ", i)
            # print("\n")
            yield amr #self.text_to_instance(amr)
